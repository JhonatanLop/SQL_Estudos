-- Views são apenas uma visualização de uma tabela física
-- podem ser usadas para formatação de dados, ou unir dados de duas tabelas (como está sendo usado neste código)
-- por ser apenas uma visualização, náo é possível salvar dados em uma view

-- IMPORTANTE!!
-- caso um tabela ou um campo de uma tabela que tenha uma view deixe de existir,
-- a view não apresentará funcionamento adequado
